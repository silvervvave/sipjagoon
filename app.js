const scenarios = [
  {
    ...
    text: "교황이 '셀주크 튀르크로부터 성지 예루살렘을 탈환하자!'며 십자군 파병을 요청합니다. 제후와 기사들을 파견하시겠습니까?",
    choices: [
      { text: "신의 뜻대로! 참전하라!", effects: {pope: 10, noble: -10, king: 0, merchant: 0}, log: "교황의 권위가 올랐으나, 기사들의 전력이 약화되었습니다." },
      { text: "우리 영지가 우선이다. 1명만 보낸다.", effects: {pope: -20, king: 10, noble: 0, merchant: 0}, log: "교황의 눈밖에 났으나 왕권이 강화되었습니다." }
    ]
  },
  {
    title: "십자군 원정 자금 조달", year: "12세기",
    text: "기사들이 먼 중동까지 가려면 막대한 비용이 필요합니다. 원정 자금을 어떻게 마련할까요?",
    choices: [
      { text: "상인들에게 돈을 빌린다.", effects: {pope: 0, noble: -10, king: 0, merchant: 20}, log: "상인들이 막대한 부를 쌓았지만 제후들은 빚더미에 앉았습니다." },
      { text: "농노들에게 세금을 10배로 걷는다.", effects: {pope: 0, noble: 10, king: 0, merchant: -10}, log: "기사들의 주머니는 가득찼으나 농노들은 겨울을 나기가 어려워졌습니다." }
    ]
  },
  {
    title: "지중해 무역의 발달", year: "12세기 후반",
    text: "십자군이 오가는 길목에 상업도시가 발달했습니다. 상인들이 세금을 낼 테니 도시의 '자치권'을 달라고 요구합니다.",
    choices: [
      { text: "자치권을 인정하고 대가를 받는다.", effects: {pope: 0, noble: 0, king: 10, merchant: 10}, log: "왕실 재정이 튼튼해지고 상업도시가 발전합니다." },
      { text: "건방진 길드를 탄압하라!", effects: {pope: 0, noble: 10, king: 0, merchant: -20}, log: "제후들의 통제력이 유지되었으나 상인들이 반란을 준비합니다." }
    ]
  },
  {
    ...
    choices: [
      { text: "약탈은 언제나 달콤하지.", effects: {pope: -20, noble: 0, king: 0, merchant: 10}, log: "십자군의 타락으로 교황의 권위가 실추되었습니다." },
      { text: "배신은 거절한다. 성지로 가자.", effects: {pope: 10, noble: -20, king: 0, merchant: 0}, log: "교황의 지지를 얻었으나 무리한 원정으로 제후들이 큰 피해를 입었습니다." }
    ]
  },
  {
    title: "십자군 전쟁의 실패와 종료", year: "13세기 말",
    text: "200년의 전쟁 끝에 결국 탈환에 실패했습니다. 교황 권위는 추락했고 제후들은 영지를 잃고 가난해졌습니다.",
    choices: [
      { text: "몰락한 기사들의 땅을 몰수한다.", effects: {pope: 0, noble: -20, king: 20, merchant: 0}, log: "제후들이 몰락하고 국왕의 힘이 막강해집니다." },
  ...
  },
  {
    ...
    text: "끔찍한 전염병으로 인구의 3분의 1이 사망했습니다. 농사지을 사람이 부족합니다.",
    choices: [
      { text: "살아남은 농노들의 세금을 감면해 준다.", effects: {pope: 0, noble: -10, king: 0, merchant: 10}, log: "농노들의 지위가 향상되며 장원 경제가 흔들리기 시작합니다." },
      { text: "농노들이 도망가지 못하게 법으로 묶는다.", effects: {pope: 0, noble: 10, king: 0, merchant: -10}, log: "제후들의 강압적인 통제로 불만이 고조됩니다." }
    ]
  },
  {
    title: "농민 반란 발생", year: "14세기 후반",
    text: "제후들의 억압에 분노한 농민들이 자크리의 난, 와트 타일러의 난 등 반란을 일으켰습니다!",
    choices: [
      { text: "어딜 까불어~!", effects: {pope: 0, noble: 10, king: -10, merchant: 0}, log: "반란은 진압되었으나 국력이 소모되었습니다." },
      { text: "농노야 농노야, 무얼 원하니?", effects: {pope: 0, noble: -20, king: 10, merchant: 0}, log: "봉건 제후들의 지배력이 크게 약화되었습니다." }
    ]
  },
  {
    title: "화약과 대포의 등장", year: "14세기",
    text: "중국으로부터 화약이 전래되었습니다. 이제 제후들의 튼튼한 성벽도 대포에 무너질 수 있습니다.",
    choices: [
      { text: "국왕 직속 포병대를 육성한다.", effects: {pope: 0, noble: -20, king: 20, merchant: 0}, log: "국왕의 군사력이 제후들을 압도하기 시작합니다." },
      { text: "기사들의 전통적인 칼과 방패의 힘을 믿는다.", effects: {pope: 0, noble: 10, king: -10, merchant: 0}, log: "전통을 지켰으나 주변국과의 경쟁에서 뒤처집니다." }
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: "적당히 협상하고 물러난다.", effects: {pope: 0, noble: 10, king: -10, merchant: 0}, log: "영토는 잃었으나 제후들의 전력은 보존되었습니다." }
    ]
  },
  {
    title: "장궁병의 활약", year: "14세기 중반",
    text: "평민들로 이루어진 장궁병들이 화살 비를 내려 기사들을 몰살시켰습니다!",
    choices: [
      { text: "상비군의 비중을 대폭 늘린다.", effects: {pope: 0, noble: -10, king: 10, merchant: 0}, log: "기사 중심의 전투 방식이 종말을 고합니다." },
      { text: "기사들의 명예를 위해 기병 돌격을 지시한다.", effects: {pope: 0, noble: 10, king: -20, merchant: 0}, log: "무모한 전술로 아군의 피해가 극심합니다." }
    ]
  },
  {
    ...
    choices: [
      { text: "잔다르크는 신의 계시다!", effects: {pope: -10, noble: 0, king: 20, merchant: 0}, log: "국왕 중심의 민족 의식이 크게 성장했습니다." },
      { text: "잔다르크는 마녀다!", effects: {pope: 10, noble: 0, king: -10, merchant: 0}, log: "교회의 지지는 지켰으나 전세가 기울어갑니다." }
    ]
  },
  {
    ...
    choices: [
      { text: "가문들이 싸우도록 내버려 두어 힘을 뺀다.", effects: {pope: 0, noble: -20, king: 10, merchant: 0}, log: "귀족들이 서로 싸우며 공멸의 길을 걷습니다." },
  ...
  },
  {
    ...
    choices: [
      { text: "몰수된 영지를 모두 국왕의 직할령으로 삼는다.", effects: {pope: 0, noble: -20, king: 20, merchant: 0}, log: "국왕의 권력이 영주들을 완벽히 압도하게 됩니다." },
  ...
  },
  {
    ...
    text: "내전이 끝나고 왕권은 강력해졌으며 봉건 영주는 몰락했습니다. 이제 국가를 어떻게 이끌어갈까요?",
    choices: [
      { text: "부유한 상공 시민 계층과 손잡고 국가를 부강하게 만든다.", effects: {pope: 0, noble: 0, king: 10, merchant: 20}, log: "절대 왕정의 기틀이 마련되었습니다! 진 엔딩 달성!" },
...
function checkGameOver(isResultPhase = false, resultMessage = "") {
  ...
  for (let key in stats) {
    if (stats[key] === 0 || stats[key] === 100) {
      ...
      // 기존 메시지 유지(교황/상업 관련)
      if (key === 'pope' && stats[key] === 0) reason = "엥이 이런 이단 같으니라고! 너 파문! 교황의 신임을 잃습니다.";
  ...
  if (currentTurn >= scenarios.length) {
    // 진 엔딩: 왕권 >= 60 && 상업 >= 60
    if (stats.king >= 60 && stats.merchant >= 60) {
      showEndScreen("승리 - 중앙 집권 국가 달성", "축하합니다! 중세의 봉건제는 무너졌습니다. 당신은 상공업자들의 막대한 재정 지원을 바탕으로 상비군을 기르고, 강력한 중앙 집권 국가(절대 왕정)의 화려한 막을 올렸습니다.");
      return true;
    }
...
window.onload = () => { setupEventListeners(); initGame(); };
